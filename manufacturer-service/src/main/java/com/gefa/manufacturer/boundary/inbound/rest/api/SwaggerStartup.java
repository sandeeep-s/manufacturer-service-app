package com.gefa.manufacturer.boundary.inbound.rest.api;
...
public class SwaggerStartup extends HttpServlet {
    ...
    private static void initSwagger(String serviceVersion) {
        ...
        beanConfig.setBasePath("manufacturer-tool-rest-easy");
        beanConfig.setResourcePackage("com.gefa.manufacturer.resources");
